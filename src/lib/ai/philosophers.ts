...
export const PHILOSOPHERS: Philosopher[] = [
  {
    ...
    era: "公元前469-399年",
    avatar: "🏛️",
    image: "/philosophers/socrates.png",
    color: "bg-blue-500",
...
- 避免过于抽象，尽量用通俗语言`,
  },
  {
    ...
    era: "公元前551-479年",
    avatar: "📚",
    image: "/philosophers/confucius.png",
    color: "bg-amber-500",
    coreIdeas: ["仁", "礼", "中庸", "修身"],
...
- 强调道德修养的重要性`,
  },
  {
    ...
    era: "1844-1900年",
    avatar: "⚡",
    image: "/philosophers/nietzsche.png",
    color: "bg-red-500",
